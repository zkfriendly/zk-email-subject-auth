...
// regex: USER_OP_HASH: [0-9]*
template UserOpHashRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[0] <== eq[11][i].out;
		multi_or[0][i].in[1] <== eq[12][i].out;
		multi_or[0][i].in[2] <== eq[13][i].out;
		multi_or[0][i].in[3] <== eq[14][i].out;
		multi_or[0][i].in[4] <== eq[15][i].out;
		multi_or[0][i].in[5] <== eq[16][i].out;
		multi_or[0][i].in[6] <== eq[17][i].out;
		multi_or[0][i].in[7] <== eq[18][i].out;
		multi_or[0][i].in[8] <== eq[19][i].out;
		multi_or[0][i].in[9] <== eq[20][i].out;
		and[14][i].b <== multi_or[0][i].out;
		multi_or[1][i] = MultiOR(2);
		multi_or[1][i].in[0] <== and[13][i].out;
		multi_or[1][i].in[1] <== and[14][i].out;
		states[i+1][14] <== multi_or[1][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][14] * states[i+2][14];
